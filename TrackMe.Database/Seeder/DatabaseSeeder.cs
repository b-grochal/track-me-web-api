    ...
    public static class DatabaseSeeder
    {
        ...
        private static void SeedTrips(DatabaseContext dbContext)
        {
            if (!dbContext.Trips.Any())
            {
                ...
                {
                    new Trip{ Name="Holiday Trip", MemberId = dbContext.BasicUsers.Single(x => x.Email.Equals("dwight@schrute.com")).Id },
                    new Trip{ Name="Sunday Trip", MemberId = dbContext.BasicUsers.Single(x => x.Email.Equals("dwight@schrute.com")).Id },
                    new Trip{ Name="Moscow Trip", MemberId = dbContext.BasicUsers.Single(x => x.Email.Equals("dwight@schrute.com")).Id }
                };
        ...
        private static void SeedSensorData(DatabaseContext dbContext)
        {
            ...
            {
                List<Location> sensorValues = new List<Location>
                {
                    new Location{UploadDate = DateTime.Now, Latitude = 50, Longitude = 50, AccelerometerX = 12, AccelerometerY = 12, AccelerometerZ = 12,
                    ...
                    new Location{UploadDate = DateTime.Now, Latitude = 50.2, Longitude = 50, AccelerometerX = 13, AccelerometerY = 13, AccelerometerZ = 13,
                        GyroscopeX = 13, GyroscopeY = 13, GyroscopeZ = 13, MagneticFieldX = 13, MagneticFieldY = 13, MagneticFieldZ = 13,
                        TripId = dbContext.Trips.Single(x => x.Name == "Holiday Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 50, Longitude = 50.2, AccelerometerX = 14, AccelerometerY = 14, AccelerometerZ = 14,
                        GyroscopeX = 14, GyroscopeY = 14, GyroscopeZ = 14, MagneticFieldX = 14, MagneticFieldY = 14, MagneticFieldZ = 14,
                        TripId = dbContext.Trips.Single(x => x.Name == "Holiday Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 50, Longitude = 50.3, AccelerometerX = 15, AccelerometerY = 15, AccelerometerZ = 15,
                        GyroscopeX = 15, GyroscopeY = 15, GyroscopeZ = 15, MagneticFieldX = 15, MagneticFieldY = 15, MagneticFieldZ = 15,
                        TripId = dbContext.Trips.Single(x => x.Name == "Holiday Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 20, Longitude = 20, AccelerometerX = 16, AccelerometerY = 16, AccelerometerZ = 16,
                    ...
                    new Location{UploadDate = DateTime.Now, Latitude = 20.2, Longitude = 20, AccelerometerX = 17, AccelerometerY = 17, AccelerometerZ = 17,
                        GyroscopeX = 17, GyroscopeY = 17, GyroscopeZ = 17, MagneticFieldX = 17, MagneticFieldY = 17, MagneticFieldZ = 17,
                        TripId = dbContext.Trips.Single(x => x.Name == "Sunday Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 20.3, Longitude = 20, AccelerometerX = 18, AccelerometerY = 18, AccelerometerZ = 18,
                        GyroscopeX = 18, GyroscopeY = 18, GyroscopeZ = 18, MagneticFieldX = 18, MagneticFieldY = 18, MagneticFieldZ = 18,
                        TripId = dbContext.Trips.Single(x => x.Name == "Sunday Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 20.4, Longitude = 20, AccelerometerX = 19, AccelerometerY = 19, AccelerometerZ = 19,
                        GyroscopeX = 19, GyroscopeY = 19, GyroscopeZ = 19, MagneticFieldX = 19, MagneticFieldY = 19, MagneticFieldZ = 19,
                        TripId = dbContext.Trips.Single(x => x.Name == "Sunday Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 16.2, Longitude = 18.9, AccelerometerX = 20, AccelerometerY = 20, AccelerometerZ = 20,
                    ...
                    new Location{UploadDate = DateTime.Now, Latitude = 16.3, Longitude = 18.8, AccelerometerX = 21, AccelerometerY = 21, AccelerometerZ = 21,
                        GyroscopeX = 21, GyroscopeY = 21, GyroscopeZ = 21, MagneticFieldX = 21, MagneticFieldY = 21, MagneticFieldZ = 21,
                        TripId = dbContext.Trips.Single(x => x.Name == "Moscow Trip").TripId},
                    new Location{UploadDate = DateTime.Now, Latitude = 16.4, Longitude = 18.7, AccelerometerX = 22, AccelerometerY = 22, AccelerometerZ = 22,
                        GyroscopeX = 22, GyroscopeY = 22, GyroscopeZ = 22, MagneticFieldX = 22, MagneticFieldY = 22, MagneticFieldZ = 22,
                        TripId = dbContext.Trips.Single(x => x.Name == "Moscow Trip").TripId}                     
                };

                foreach (Location values in sensorValues)
                {
